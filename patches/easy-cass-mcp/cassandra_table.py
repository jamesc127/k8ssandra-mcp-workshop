...
class CassandraTable:
    ...
    async def get_compaction_strategy(self) -> Dict[str, Any]:
        ...
        # The driver returns CQL maps as OrderedMapSerializedKey, which is a
        # Mapping but not a dict - so check against Mapping.
        if isinstance(compaction_options, Mapping):
