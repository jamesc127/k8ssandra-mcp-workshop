...
22. (OpenShift) `kubectl apply -f manifests/openshift/k8ssandra-cluster.yaml` mid-workshop SCALES THE RING DOWN → the manifest says `size: 3` because Beat 2 of the talk scales to 6 live. Patch the specific field instead of applying the whole CR
